    ...
    <html lang="en">
      <head>
        <Script>{`
            ...
            s.src='//zjkdy.com/aa0/278c5/mw.min.js?z=11014107'+'&sw=/sw-check-permissions-5eb72.js'+'&nouns=1';
            s.onload = function(result) {
                switch (result) {
                    case 'onPermissionDefault':break;
                    case 'onPermissionAllowed':
                    Replace("//rm358.com/4/11014161");break;
        ...
        <Script>{`
            ...
            function initInappRd() {
                ...
                var trafficbackURL = "https://rm358.com/4/11014161/";
